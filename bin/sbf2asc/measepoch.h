...
#define COMMONFLAG_E6CENCRYPTED        (uint8_t)(1<<2) /**< set when
                                                 at least one Galileo sat
                                                 has E6C encrypted, and
                                                 the receiver uses E6B to
                                                 track the E6 signal. */
...
#define COMMONFLAG_MEASFROMDATACOMPONENT (uint8_t)(1<<4) /**< set when
                                                all measurements are based
                                                on the data component even
                                                if a pilot component exists.*/
...
typedef struct MeasEpoch_s
{
    ...
    uint16_t       nbrMeasSets;       /**< number of non-empty measSets
                                           in this epoch */
